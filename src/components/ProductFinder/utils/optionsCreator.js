...
export const getOption = ({
  ...
  const hoverDivStyles = `${selectedOptionStyles} sm:mx-1 md:hover:border md:hover:border-2 sm:h-140px sm:w-140px md:h-160px md:w-160px flex flex-grow flex-col justify-center items-center cursor-pointer md:hover:bg-gray-100 p-1 sm:p-2`;
  const outerDivStyle = `sm:h-140px md:h-160px mb-4 sm:mb-8 mx-0.5 sm:mx-1`;
  return (
