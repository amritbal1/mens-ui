...
export const getOption = ({
  ...
  const selectedOptionStyles = isChecked ? "bg-lilac-100" : "";
  ...
  const outerDivStyle = ` rounded-full h-110px sm:h-140px md:h-160px mb-4 mr-2 sm:mr-8 mx-1`;
  return (
    <div class={outerDivStyle} key={value}>
      <div class={hoverDivStyles} onClick={() => clickHandlerFn(value)}>
        <img
          src={imageUrl}
          alt="skin"
          class="h-60px w-80px md:h-100px md:w-100px"
        />
