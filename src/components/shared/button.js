export const FinderButton = ({ text, onClick, disabled, styles }) => {
  ...
  const cssStyles = ` ${disabledStyle} py-3 px-5 sm:px-8 shadow-md font-normal rounded-lg text-white border border-lilac-600 text-lilac-600 uppercase focus:outline-none tracking-wide text-sm flex-shrink-0 ${styles}`;
  return (
